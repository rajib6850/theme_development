<?php get_header(  ); ?>
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                ...
                                <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                    <h2 class="mb-3 text-white font-weight-bold"><?php bloginfo( 'name' ); ?></h2>
                            ...
                            <div class="carousel-item">
                                ...
                                <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                    <h2 class="text-white font-weight-bold"><?php bloginfo('name'); ?></h2>
                                    <div class="d-flex">
                                        <p><?php bloginfo( 'description' ); ?></p>
                                    </div>
                                    <a href="" class="btn btn-lg btn-outline-light mt-4">Read More</a>
                            ...
                            <div class="carousel-item">
                                <img class="w-100" src="<?php echo get_template_directory_uri(); ?>/img/carousel-3.jpg" alt="Image">
                                <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                    <h2 class="text-white font-weight-bold"><?php bloginfo( 'name' ); ?></h2>
                                    <div class="d-flex">
                                       <p><?php bloginfo('description'); ?></p>
                ...
                <div class="container bg-white pt-5">
                    ...
                    <div class="row blog-item px-3 pb-5">
                        <div class="col-md-5">
                            <img class="img-fluid mb-4 mb-md-0" src="<?php echo get_template_directory_uri(); ?>/img/blog-1.jpg" alt="Image">
                        </div>
                        <div class="col-md-7">
                ...
                <div class="container bg-white pt-5">
                    <div class="row blog-item px-3 pb-5">
                        <div class="col-md-5">
                            <img class="img-fluid mb-4 mb-md-0" src="<?php echo get_template_directory_uri(); ?>/img/blog-4.jpg" alt="Image">
                        </div>
                        <div class="col-md-7">
                            <h3 class="mt-md-4 px-md-3 mb-2 py-2 bg-white font-weight-bold">Lorem ipsum dolor sit amet</h3>
                            <div class="d-flex mb-3">
                    ...
                    <div class="row blog-item px-3 pb-5">
                        <div class="col-md-5">
                            <img class="img-fluid mb-4 mb-md-0" src="<?php echo get_template_directory_uri(); ?>/img/blog-5.jpg" alt="Image">
                        </div>
                        <div class="col-md-7">
                            <h3 class="mt-md-4 px-md-3 mb-2 py-2 bg-white font-weight-bold">Lorem ipsum dolor sit amet</h3>
                            <div class="d-flex mb-3">
                    ...
                    <div class="row blog-item px-3 pb-5">
                        <div class="col-md-5">
                            <img class="img-fluid mb-4 mb-md-0" src="<?php echo get_template_directory_uri(); ?>/img/blog-6.jpg" alt="Image">
                        </div>
                        <div class="col-md-7">
                            <h3 class="mt-md-4 px-md-3 mb-2 py-2 bg-white font-weight-bold">Lorem ipsum dolor sit amet</h3>
                            <div class="d-flex mb-3">
